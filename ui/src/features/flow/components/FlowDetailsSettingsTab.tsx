  ...
  return (
    <>
      <div className="space-y-6">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <SectionCard
              ...
              description="Manage the basic identity of this flow."
            >
              <FormInput
        ...
        <SectionCard
          title="Harbor"
          description="Export this flow as a portable bundle, or import a bundle to replace its configuration."
        ...
        <SectionCard
          ...
          description="Duplicate this flow into a new draft."
        >
          <FlowActionRow
            icon={Copy}
