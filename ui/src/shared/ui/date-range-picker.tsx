...
import { DateInput } from '@/shared/ui/date-input.tsx'
...
export interface DateRangePickerProps {
  ...
  showCompare?: boolean
  /** Optional classes for trigger button */
...
export const DateRangePicker: FC<DateRangePickerProps> = ({
  ...
  }, [getPresetRange, range.from, range.to])
  ...
  return (
    ...
    >
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          className={cn('h-8 justify-between gap-1 px-2 text-xs font-normal', triggerClassName)}
        >
              ...
              <div>
                <Calendar
                  ...
                  onSelect={(value: { from?: Date; to?: Date } | undefined) =>
                    value?.from != null && setRange({ from: value.from, to: value?.to })}
                  selected={range}
